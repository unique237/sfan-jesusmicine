    ...
    <div className="max-w-[1600px] gap-4 grid grid-cols-12 grid-rows-2 px-8 pt-3 items-center mx-auto">
      <Card className="col-span-12 sm:col-span-4 h-[350px] flex flex-col items-center">
        <CardHeader className="absolute z-10 top-1 flex-col !items-start text-center">
          <p className="text-tiny text-white/60 uppercase font-bold">Mediatheque 1</p>
      ...
      <Card className="col-span-12 sm:col-span-4 h-[350px] flex flex-col items-center">
        <CardHeader className="absolute z-10 top-1 flex-col !items-start text-center">
          <p className="text-tiny text-white/60 uppercase font-bold">Mediatheque 2</p>
          <NavLink to='/'><h4 className="text-white font-medium text-2xl">Random Link</h4></NavLink>
        </CardHeader>
        <img
          removeWrapper
      ...
      <Card className="col-span-12 sm:col-span-4 h-[350px] flex flex-col items-center">
        <CardHeader className="absolute z-10 top-1 flex-col !items-start text-center">
          <p className="text-tiny text-white/60 uppercase font-bold">Mediatheque 3</p>
          <NavLink to='/'><h4 className="text-white font-medium text-2xl">Random Link</h4></NavLink>
        </CardHeader>
        <img
          removeWrapper
      ...
      <Card isFooterBlurred className="w-full h-[350px] col-span-12 sm:col-span-5 flex flex-col items-center">
        <CardHeader className="absolute z-10 top-1 flex-col items-start text-center">
          <p className="text-tiny text-white/60 uppercase font-bold">Eglises SFAN</p>
      ...
      <Card isFooterBlurred className="w-full h-[350px] col-span-12 sm:col-span-7 flex flex-col items-center">
        <CardHeader className="absolute z-10 top-1 flex-col items-start text-center">
          ...
          <h4 className="text-white/90 font-medium text-xl">Notre dernier festival!</h4>
        </CardHeader>
        <img
          removeWrapper
